    ...
    <section className="about-section security-section">
      <div className="section-container">
        <div className="section-header text-center">
          ...
          <p className="scroll-reveal delay-200">Ghostrade operates on a strictly non-custodial architecture. Your funds never leave your exchange.</p>
        </div>
        <div className="security-grid">
          <div className="security-card scroll-reveal delay-100">
            <Shield size={24} className="icon-emerald" />
            <h4>Non-Custodial Design</h4>
            <p>Your capital remains secured within your personal exchange account. Ghostrade only transmits mathematical telemetry data.</p>
          </div>
  ...
  return (
    <PublicLayout onModeSwitch={(mode) => navigate('/connect', { state: { mode } })}>
      <div className="ghost-about-page">
        ...
        {/* ===================================================================
            2. INSTITUTIONAL ANALYSIS PLATFORM SPECIFICATIONS
           =================================================================== */}
                  ...
                  >
                    ...
                    <div className="tab-grid">
                      <motion.div className="tab-info" variants={tabItemVariants}>
                        ...
                        <p>
                          Every analytical setup generated by Ghostrade is recorded in an immutable ledger, allowing users to verify win rates, expectancy, and execution timestamps against live exchange data.
                        </p>
                    ...
                    <div className="tab-grid">
                      <motion.div className="tab-info" variants={tabItemVariants}>
                        ...
                        <ul className="spec-list">
                          ...
                          <motion.li variants={tabItemVariants}><CheckCircle2 size={16} className="icon-emerald" /> <span>Probability Density Scoring for Every Setup</span></motion.li>
                        </ul>
                      </motion.div>
                  ...
                  >
                    ...
                    <div className="tab-grid">
                      <motion.div className="tab-info" variants={tabItemVariants}>
                        ...
                        <p>
                          Ghostrade bypasses slow retail web interfaces by maintaining direct FIX protocol connections to prime broker liquidity centers, delivering instant routing telemetry without lag.
                        </p>
                        <ul className="spec-list">
                    ...
                    <div className="tab-grid">
                      <motion.div className="tab-info" variants={tabItemVariants}>
                        ...
                        <ul className="spec-list">
                          ...
                          <motion.li variants={tabItemVariants}><CheckCircle2 size={16} className="icon-emerald" /> <span>50% Risk Scale-Outs with Infinite Runner Trailing Stops</span></motion.li>
        ...
        <section className="about-section matrix-section">
          <div className="section-container">
            <div className="section-header text-center">
              ...
              <h2 className="scroll-reveal delay-100">Retail Software vs. Ghostrade Engine</h2>
              <p className="scroll-reveal delay-200">Understanding the fundamental difference between standard retail analysis tools and an institutional quant infrastructure.</p>
            </div>
              ...
              <table className="matrix-table">
                <thead>
                  <tr>
                    ...
                    <th className="highlight-col">GHOSTRADE QUANT ENGINE</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="scroll-reveal delay-100">
                    <td className="spec-name"><Cpu size={14} /> Setup Generation</td>
        ...
        <section className="about-section faq-section">
          <div className="section-container">
            <div className="section-header text-center">
              ...
              <p className="scroll-reveal delay-200">Everything you need to know about system access, broker connections, and risk tracking protocols.</p>
            </div>

            <div className="faq-list">
              {[
                {
                  q: "Does Ghostrade hold custody of my funds or assets?",
                  a: "No. Ghostrade is a market analysis platform — it does not hold, manage, or have access to your funds. Any paper trading features use simulated virtual funds only for educational purposes."
                },
                {
                  q: "How does the analysis engine eliminate emotional bias?",
                  a: "All analysis is generated by deterministic algorithms with fixed statistical parameters. The AI engine processes raw market data mathematically — it has no emotions, opinions, or biases. Every output is a quantitative observation, not a subjective opinion."
                },
                {
                  q: "Can I use Ghostrade for multiple assets?",
                  a: "Yes. Ghostrade can analyze any publicly traded asset including stocks, crypto, forex, and indices. Simply provide a chart image or asset ticker to receive AI-generated quantitative analysis."
                },
                {
                  q: "What happens during extreme market volatility?",
                  a: "During high-volatility events, the analysis engine activates its Shield Mode — a built-in circuit breaker that flags when market data is unreliable or when statistical confidence drops below safe thresholds. This protects the quality of analysis output."
                },
                {
                  q: "How is analysis accuracy tracked?",
                  a: "Every analysis is logged with a unique hash and timestamp. Outcomes are automatically tracked against real market data, and the system's historical accuracy is transparently displayed. Note: Past analytical accuracy does not guarantee future results."
                }
              ].map((faq, idx) => (
                <motion.div 
                  key={idx} 
          ...
          <div className="footer-container">
            <div className="footer-top">
              <div className="footer-brand scroll-reveal">
                <div className="brand-header">
                  ...
                  <span className="brand-title">Ghostrade</span>
                </div>
                <p className="brand-desc">
                  AI-powered quantitative market analysis platform. Built for data-driven insights and educational analysis.
                </p>
              </div>
              ...
              <div className="footer-links-grid">
                ...
                <div className="footer-col scroll-reveal delay-300">
                  ...
                  <ul>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/legal#terms'); }}>Terms of Service</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/legal#privacy'); }}>Privacy Policy</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/legal#risk'); }}>Risk Disclosure</a></li>
                    <li><a href="#" onClick={(e) => { e.preventDefault(); navigate('/legal#msa'); }}>Master Service Agreement</a></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="footer-bottom">
              <div className="copyright scroll-reveal delay-400">
                &copy; {new Date().getFullYear()} Ghostrade. All rights reserved. AI-Powered Quantitative Analysis Platform.
              </div>
              <div className="disclaimer scroll-reveal delay-500">
                Disclaimer: Ghostrade is an AI-powered analysis platform for educational and informational purposes only. It is NOT a SEBI-registered Investment Adviser or Research Analyst. Investment in securities market is subject to market risks. AI-generated analysis does not constitute investment advice. Past analytical performance does not guarantee future results. Consult a SEBI-registered adviser before investing.
              </div>
            </div>
          </div>
        </footer>
